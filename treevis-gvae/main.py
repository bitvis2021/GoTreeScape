...
if __name__ == '__main__':
    ...
    # 2.1. generate the weighted file based on the rules-cfg
    ...
    # # 3. train the weighted model: see train_weight.py
    ...
    # TODO
    # folder_name = '8_1630570538' #3_1628854598, 2_1628849300, 1_1628846946
    # inputspec = []
    ...
    # outputspec, embeddings = test_visvae(inputspec, 'trainingdata/rules-cfg.txt', 'trained/' + folder_name + '/vae_H256_D256_C888_333_L20_B200.hdf5')
