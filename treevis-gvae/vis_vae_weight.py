`##################################################
## Wrapper for tree visualizations based on GoTree grammar
...
class VisVAE():
    def __init__(self, weights_file, rules, rules_weight, max_len, batch_size, latent_dim):
        self.rules = rules
        ...
        self.vae = ModelVAE()
        self.vae.load(self.rules, rules_weight, weights_file, max_length=self.max_len, batch_size=batch_size, latent_rep_size=self.latent_dim, hypers=hypers)
