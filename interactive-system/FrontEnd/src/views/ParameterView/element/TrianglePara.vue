...
export default {
    ...
    mounted: function() {
        // console.log('tri-para', this.elementDsl)
    },
    created: function () {
        ...
        if (!('Direction' in this.elementDsl)) {
            this.elementDsl.Direction = 'top'
        } else {
            this.Direction = this.elementDsl.Direction
        }
    ...
    methods: {
        ...
        changeDSL_() {
            ...
            this.elementDsl.Direction = this.Direction
