<template>
    <div id="circlePara">        
        ...
        <el-row type="flex" align="middle" justify="space-around">
            ...
            <el-col :span="1"></el-col>
            <el-col :span="15" class="panel_control">
                <el-select v-model="SizeOption" size="mini" @change="changeDSL_">
                  <el-option
        ...
        <el-row v-if="SizeOption==='static'" type="flex" align="middle" justify="space-around" class="outer-row">
            <el-col :span="1"></el-col>
            <el-col :span="6" class="panel_para">
                <span>radius</span>
            </el-col>
...
export default {
    ...
    mounted: function() {
        // console.log('circle-para', this.elementDsl)
    },
    created: function () {
        ...
        if (!('SizeOption' in this.elementDsl)) {
            this.elementDsl.SizeOption = 'fill'
        } else {
            this.SizeOption = this.elementDsl.SizeOption
        }
        ...
        if ('StaticSize' in this.elementDsl) {
            this.StaticSize = this.elementDsl.StaticSize
        } else {
            this.elementDsl.StaticSize = this.StaticSize
        }
    },
    computed: {
        ...mapState([
    ...
    methods: {
        ...
        changeDSL_() {
            ...
            this.elementDsl.SizeOption = this.SizeOption
