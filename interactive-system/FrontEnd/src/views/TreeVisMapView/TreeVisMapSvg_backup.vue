    ...
    export default {
       ...
       //                   let cluster_inner_neighbor = searching_results['cluster_inner_neighbor']
        ...
        mounted: function() {
            ...
            console.log('self.existedTreeVisIndexList', self.existedTreeVisIndexList)
            self.initViewSize()
        ...
        methods: {
            ...
            zoomIntoSearchResults: function() {
                let self = this
                let avgItemPos = [0, 0]
                console.log('this.treevisSearchResult', this.treevisSearchResult)
     ...
     //             self.loadClusterResults(loadClusterDefer)
            ...
            updateClusterContentItemList: function() {
                ...
                if (drawingProjectionPosItemIndexSet == null) {
                    ...
                    console.log('drawingProjectionPosItemIndexList', drawingProjectionPosItemIndexList)
                    ...
                    console.log('[singleClusterItemList]', [singleClusterItemList])
            ...
            computeDisplayAndDataRange: function() {
                ...
                return {'data': displayedDataRange, 'display':displayRange }
            },
