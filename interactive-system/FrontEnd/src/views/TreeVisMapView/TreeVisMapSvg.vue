    ...
    <div class="tree-vis-map-svg-container" :ref="treeVisMapContainerRef">
        ...
        <div class="treevis-preview" v-for="singleRepresentativeObj in previewRepresentativeObjList"
            ...
            <TreeCanvas :treeCanvasKey="treeCanvasDefaultPreviewKey" 
                ...
                :initRender="true"
                :nodeArrayWithValueObj="nodeArrayWithValueObjThumbnail"
                :nodeArrayWithValue="nodeArrayWithValueThumbnail"
                :hierarchicalData="hierarchicalDataThumbnail">
            </TreeCanvas>
        </div>
    ...
    export default {
        ...
        data() {
            return {
                ...
                previewOverlappingThreshold: 40, // indicates the minimum distance between the tree vis previews
                displayedLevel: 0,
                zoomingRatio: 1,
        ...
        watch: {
            ...
            underlyingDatasetSignal: function() {
                // initialize the underlying dataset
                this.initNodeArrayWithValueObj()
                this.initHierarchicalDataObj()
                this.initNodeArrayWithValue()
        ...
        methods: {
            ...
            initViewSize: function() {
                ...
                this.treeVisMapCanvasUpdateYThreshold = treeVisMapCanvasHeight / 200
                this.treeVisMapCanvasUpdateXThreshold = treeVisMapCanvasWidth / 200
            ...
            initNodeArrayWithValueObj: function() {
                ...
                self.nodeArrayWithValueObjThumbnail = sysDatasetObj.getNodeArrayWithValueObjThumbnail()
            },
            initHierarchicalDataObj: function () {
                ...
                self.hierarchicalDataThumbnail = sysDatasetObj.getTreeDatasetThumbnail()
            },
            initNodeArrayWithValue: function() {
                ...
                self.nodeArrayWithValueThumbnail = sysDatasetObj.getNodeArrayWithValueThumbnail()
            },
     ...
     //             self.loadClusterResults(loadClusterDefer)
            ...
            initZoomOperator: function() {
                ...
                let zoomOperator = d3.zoom().scaleExtent([minZoomRatio, maxZoomRatio])
                    .on("zoom", self.zoomHandler)
                    .on("end", self.zoomEndHandler)
            ...
            updateTreevisPreviewRepresentatives: function (transform_event, zoom_end) {
                ...
                let selectedPreviewAmount = self.selectedPreviewAmount
                ...
                if (zoom_end) {
                    let previewRepresentativeIndex = 0
                    // console.log('previewRepresentativeObjList length', previewRepresentativeObjList.length)
                    ...
                    for (let i = 0; i < previewRepresentativeObjList.length; i++) {
                        ...
                        if ((!self.withinScreenSpace(previewRepresentativeObj)) || (previewRepresentativeIndex > selectedPreviewAmount)) {
                            previewRepresentativeObj['hidden'] = true
                        } else {
                            previewRepresentativeIndex += 1
                            remainedPreviewRepresentativeObjList.push(previewRepresentativeObj)
                        }
                    }
                    // console.log('remainedPreviewRepresentativeObjList length', remainedPreviewRepresentativeObjList.length)
            ...
            arrangePreviewRepresentativeObjList: function() {
                ...
                let displayedRepresentativeCount = 0
                for (let j = 0; j < previewRepresentativeObjList.length; j++) {
                    ...
                    if ((drawingProjectionPosItemIndexSet == null) || (drawingProjectionPosItemIndexSet.has(dslIndex))) {
                        ...
                        displayedRepresentativeCount += 1
                    } else {
            ...
            updatePreviewRepresentativeList: function(random_state=false) {
                ...
                // console.log('remainedPreviewClusterRepresentativeObjList', remainedPreviewClusterRepresentativeObjList.length)
            ...
            randomSelectPreviewRepresentative: function(random_state=false) {
                // random select the preview representative tree visualizations
                let self = this
                ...
                if (filterDSLCollection != null) {
                    ...
                    console.log('filterDSLCollection is null')
                }
                while ((index_2 < clusterRepresentativeList.length) && (selectedAmount < selectedPreviewAmount)) {
                    ...
                    if ((filterDSLCollectionSet != null) && (!filterDSLCollectionSet.has(itemIndex))) {
                        index_2 = index_2 + 1
                        continue
                    }
            ...
            zoomEndHandler: function () {
                ...
                var transform_ratio = transformEvent.k
                let updateUnderlyingDataState = self.updateUnderlyingDataState
                // if the dispay and data range exceed the threshold, then update the zooming ratio
                ...
                // self.updateWholeProjectionView(transformEvent, zoomEnd)
            ...
            zoomHandler: function () {
                ...
                let displayAndDataRangeBeforeUpdate = self.currentDisplayAndDataRange
                let displayAndDataRange = self.computeDisplayAndDataRange()
                // hide the tooltip on the treeVisMap
                self.hideTooltip()
                if (((displayAndDataRangeBeforeUpdate == null) || (self.zoomChangeExceedThreshold(displayAndDataRangeBeforeUpdate, displayAndDataRange))) && !updateUnderlyingDataState) { 
