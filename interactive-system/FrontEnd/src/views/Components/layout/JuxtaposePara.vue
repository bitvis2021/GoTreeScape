...
export default {
    ...
    mounted: function() {
        ...
        console.log('this.axisDsl', this.axisDsl)
    ...
    methods: {
        changeMarginUnit: function() {
            // console.log('this.RootMarginUnit', this.marginUnit)
    ...
    computed: {
        ...
        hoverFlag() {
            if (this.hoverParamAxis === this.axis.toLowerCase() && this.hoverParam === 'RootMargin') {
                return true
            } else {
                return false
            }
