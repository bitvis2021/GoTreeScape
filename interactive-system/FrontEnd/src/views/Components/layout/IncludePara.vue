<template>
    <div>
        <el-row type="flex" align="middle" justify="space-around" :class="(hoverFlag0 ? 'hover':'') + ' outer-row'">
        ...
        <el-row type="flex" align="middle" justify="space-around" :class="(hoverFlag1 ? 'hover':'') + ' outer-row'">
            <el-col :span="1"></el-col>
            <el-col :span="6" class="panel_para">
...
export default {
    ...
    computed: {
        ...
        hoverFlag0() {
            if (this.hoverParamAxis === this.axis.toLowerCase() && this.hoverParam === 'RootLeftPadding') {
                return true
            } else {
                return false
            }
        ...
        hoverFlag1() {
            if (this.hoverParamAxis === this.axis.toLowerCase() && this.hoverParam === 'RootRightPadding') {
                return true
            } else {
                return false
            }
